# This code was taken from https://blog.yadutaf.fr/2017/09/10/running-a-graphical-app-in-a-docker-container-on-a-remote-server/
# and modified

# Prepare target env
CONTAINER_DISPLAY="0"
CONTAINER_HOSTNAME="onstutorial"
